local colors = {
    ...
    dark_cyan = { '#81A1C1', '#266269' , '#25747d' , '#1b6a73' , '#316a71' , '#2b5d63' },
     dark_red = { '#D08770', '#8b3434' , '#a13131' , '#992525' , '#914141' , '#833b3b' },
  dark_yellow = { '#EBCB8B', '#835d1a' , '#9a6b16' , '#8f610d' , '#8c6724' , '#7c5c20' },
  dark_purple = { '#B48EAD', '#7e3992' , '#8f36a9' , '#862aa1' , '#854897' , '#79428a' },
